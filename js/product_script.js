...
const products = [
  // New products from your images
  {
    id: 3,
    title: "Zetanac-SP",
    description:
      "Combination therapy containing Aceclofenac, Paracetamol & Serratiopeptidase for enhanced pain relief and anti-inflammatory action.",
    price: 35,
    image: "images/product_images/new-1.jpeg",
    category: "NSAID",
    badge: "Combination",
    features: [
  ...
  },
  {
    ...
    title: "ZectaCold",
    description:
      "Triple action pediatric cold & fever relief formula with Paracetamol, Phenylephrine Hydrochloride & Chlorpheniramine Maleate.",
    price: 28,
    image: "images/product_images/new-2.jpeg",
    category: "Pediatric",
    badge: "Syrup",
    features: [
  ...
  },
  {
    ...
    title: "ZectaVive-XT",
    description:
      "Iron & Folic Acid supplement with Ferrous Ascorbate 30mg + Folic Acid 550mcg for treating iron deficiency anemia.",
    price: 32,
    image: "images/product_images/new-3.jpeg",
    category: "Vitamin",
    badge: "Suspension",
    features: [
  ...
  },
  {
    ...
    title: "Zemicobal",
    description:
      "Neuropathy relief formula with Methylcobalamin 1500mcg + Alpha Lipoic Acid 100mg + Folic Acid + Pyridoxine + Vitamin D3.",
    price: 45,
    image: "images/product_images/new-4.jpeg",
    category: "Vitamin",
    badge: "Tablets",
    features: [
      "Nerve regeneration",
  ...
  },
  {
    ...
    title: "ZectaVit-19G",
    description:
      "Comprehensive multivitamin, multimineral and antioxidant syrup with 19 essential nutrients for overall health support.",
    price: 38,
    image: "images/product_images/new-6.jpeg",
    category: "Vitamin",
    badge: "225ml Syrup",
    features: [
  ...
  },
  {
    ...
    title: "ZetCef-O",
    description:
      "Antibiotic combination of Cefpodoxime Proxetil & Ofloxacin tablets for treating bacterial infections effectively.",
    price: 42,
    image: "images/product_images/new-7.jpeg",
    category: "Antibiotic",
    badge: "10x10 Tablets",
    features: [
  ...
  },
  {
    ...
    title: "Mefzec-P DS",
    description:
      "Pediatric suspension combining Mefenamic Acid & Paracetamol for effective pain and fever relief in children.",
    price: 26,
    image: "images/product_images/new-8.jpeg",
    category: "Pediatric",
    badge: "60ml Suspension",
    features: [
      "Pediatric formulation",
      "Pain & fever relief",
      "Mango flavored",
  ...
  },
  {
    ...
    title: "ZetCef-1.5GM",
    description:
      "Injectable antibiotic containing Ceftriaxone & Sulbactam for serious bacterial infections requiring parenteral therapy.",
    price: 55,
    image: "images/product_images/new-9.jpeg",
    category: "Antibiotic",
    badge: "Injection",
    features: [
      "Injectable formulation",
      "Hospital grade antibiotic",
      "I.M./I.V. administration",
  ...
  },
  {
    ...
    features: ["Suppresses cough reflex", "Non-narcotic", "Fast-acting relief"],
  },
  {
    id: 11,
    title: "Esomeprazole",
...
// Category-specific URLs functionality
...
function updateMetaForCategory(category) {
  ...
  const metaInfo = {
    ...
    'vitamin': {
      title: 'Zectapure Vitamins & Supplements - Essential Nutritional Support',
      description: 'Complete range of vitamins, minerals, and nutritional supplements including iron, folic acid, and vitamin complexes for optimal health.'
    },
    'pediatric': {
      title: 'Zectapure Pediatric Medicines - Safe & Effective Child Healthcare',
      description: 'Specialized pediatric formulations including syrups and suspensions designed for safe and effective treatment of children.'
    }
  };
  ...
  const defaultMeta = {
    ...
    description: 'Explore Zectapure\'s premium pharmaceutical products including NSAIDs, Antibiotics, Vitamins, Pediatric medicines and more.'
  };
...
function updateBreadcrumbs() {
  ...
  if (category) {
    ...
    const categoryNameElement = document.getElementById('custom-category-name');
